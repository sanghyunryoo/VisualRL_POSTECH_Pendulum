...
class Viewer(mujoco_viewer.MujocoViewer):
    ...
    def _sensorupdate(self):
        ...
        pos = qpos
        sensor_data = [[pos[0]], [sin(-qpos[1]-pi)], [cos(-qpos[1]-pi)], [-qpos[1]-pi], [qvel[0]], [-qvel[1]], [action], [total_reward]]
